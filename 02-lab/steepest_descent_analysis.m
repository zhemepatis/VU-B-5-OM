...
initial_point = [0, 0];
[iterations, func_calls, gammas, results] = steepest_descent(f, initial_point, grad, [0, 0.8]);

x_values = results(:, 1);
y_values = results(:, 2);
z_values = f(x_values, y_values);
grad_values = grad(x_values, y_values);
table_data = [x_values y_values, z_values, grad_values, gammas];
write_intermediate_values(table_data, "output/excel/steepest_descent_method_0_0.xlsx");
...
grad_values = grad(x_values, y_values);
table_data = [x_values y_values, z_values, grad_values, gammas];
write_intermediate_values(table_data, "output/excel/steepest_descent_method_1_1.xlsx");
...
grad_values = grad(x_values, y_values);
table_data = [x_values y_values, z_values, grad_values, gammas];
write_intermediate_values(table_data, "output/excel/steepest_descent_method_custom_point.xlsx");
